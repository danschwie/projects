...
namespace ProjectEuler.Solutions
{
  ...
  public class Problem14 : IIntProblem
  {
    public int _answer = 0;
    public long _maxElements = 0;
    ...
    private void GenerateSequence(int startingNumber)
    {
      long n = startingNumber;
      int numElements = 0;
